...
| 类别 | 组件 |
|------|------|
| 基础 | YoButton（primary/secondary/ghost/danger）、YoSegmentedButton（tab 白块 / capsule 强调块）、YoIconButton、YoTextField（IME 安全）、YoSelect、YoCheckbox、YoBadge、YoProgressBar |
