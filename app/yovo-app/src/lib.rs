...
pub fn run() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let builder = tauri::Builder::default().setup(move |app| {
        ...
        let state = AppState {
            ...
            library: std::sync::Mutex::new(yovo_domain::CommandLibrary::empty()),
            index_cancels: std::sync::Mutex::new(std::collections::HashMap::new()),
